...
$database_name = 'bimitech_phplist';

# what user has access to this database
$database_user = 'bimitech';

# and what is the password to login to control the database
$database_password = 'KXH6P.rc3J+.;E8P';
...
define('PHPMAILERHOST', 'tls://smtp.gmail.com');

# if you want to use smtp authentication when sending the email uncomment the following
# two lines and set the username and password to be the correct ones
$phpmailer_smtpuser = 'someids@gmail.com';
$phpmailer_smtppassword = 'sTrapok01';
...
$bounce_mailbox_user = 'someids@gmail.com';
$bounce_mailbox_password = 'sTrapok01';
