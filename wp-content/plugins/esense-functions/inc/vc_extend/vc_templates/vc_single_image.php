...
$caption = $img_link_large = $link = $img_link_target = $alignment = $el_class = $style = $external_style = $border_color = $css = $dp_animation = '';
...
$output = '
	<div class="' . esc_attr( trim( $css_class ) ) . '"'.dp_getAnimation($dp_animation).'>
