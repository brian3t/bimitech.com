<?php
$output = $title = $el_class = $open = $dp_animation = '';
extract(shortcode_atts(array(
    'title' => esc_attr__("Click to toggle", 'esense-functions'),
    'el_class' => '',
    'open' => 'false',
    'dp_animation' => ''
), $atts));
...
$animation = dp_getAnimation($dp_animation);
$output .= '<div class="'.$css_class.'"'.$animation.'>'.wpb_js_remove_wpautop($content, true).'</div>'.$this->endBlockComment('toggle')."\n";
