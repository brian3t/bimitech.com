...
(function($) {
    ...
    DateTimePicker.prototype = {
        ...
        fillDate: function() {
            ...
            var day = EsenseGlobal.getDaysInMonth(prevMonth.getUTCFullYear(), prevMonth.getUTCMonth());
                        ...
                        case "th":
                            switch (target[0].className) {
                                ...
                                case "next":
                                    ...
                                    var navFnc = EsenseGlobal.modes[this.viewMode].navFnc;
                                    var step = EsenseGlobal.modes[this.viewMode].navStep;
        ...
        showMode: function(dir) {
            ...
            this.widget.find(".datepicker > div").hide().filter(".datepicker-" + EsenseGlobal.modes[this.viewMode].clsName).show()
        },
        destroy: function() {
            this._detachDatePickerEvents();
            this._detachDatePickerGlobalEvents();
    ...
    function getTemplate(timeIcon, pickDate, pickTime, is12Hours, showSeconds, collapse) {
        if (pickDate && pickTime) {
            ...
            return '<div class="bootstrap-datetimepicker-widget dropdown-menu">' + '<div class="datepicker">' + EsenseGlobal.template + "</div>" + "</div>"
        }
    }
    function UTCDate() {
    ...
    var EsenseGlobal = {
        ...
        getDaysInMonth: function(year, month) {
            return [31, EsenseGlobal.isLeapYear(year) ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][month]
        },
        headTemplate: "<thead>" + "<tr>" + '<th class="prev">&lsaquo;</th>' + '<th colspan="5" class="switch"></th>' + '<th class="next">&rsaquo;</th>' + "</tr>" + "</thead>",
        contTemplate: '<tbody><tr><td colspan="7"></td></tr></tbody>'
    };
    EsenseGlobal.template = '<div class="datepicker-days">' + '<table class="table-condensed">' + EsenseGlobal.headTemplate + "<tbody></tbody>" + "</table>" + "</div>" + '<div class="datepicker-months">' + '<table class="table-condensed">' + EsenseGlobal.headTemplate + EsenseGlobal.contTemplate + "</table>" + "</div>" + '<div class="datepicker-years">' + '<table class="table-condensed">' + EsenseGlobal.headTemplate + EsenseGlobal.contTemplate + "</table>" + "</div>";
    var TPGlobal = {
