...
(function () {
    ...
    jQuery(function (jQuery) {
        jQuery('.esense_opengraph_upload_image_button').click(function () {
            var formfield = jQuery(this).siblings('.esense_opengraph_upload_image');
            var preview = jQuery(this).siblings('.esense_opengraph_preview_image');
        ...
        jQuery('.esense_opengraph_clear_image').click(function () {
            var defaultImage = jQuery(this).parent().siblings('.esense_opengraph_default_image').text();
            jQuery(this).parent().siblings('.esense_opengraph_upload_image').val('');
            jQuery(this).parent().siblings('.esense_opengraph_preview_image').attr('src', defaultImage);
            return false;
        });
    });
