...
jQuery(document).ready(function(){
	...
	jQuery('.esense-mainmenu-toggle').click(function(){
	jQuery('#esense-page-box').toggleClass('is-mobile-menu');
	jQuery('#esense-mobile-menu').toggleClass('is-mobile-menu');
...
jQuery(window).resize(function () {
	...
	if(typeof $Esense_TABLET_WIDTH != 'undefined') {
		if (jQuery(window).width()> $Esense_TABLET_WIDTH) {
		   jQuery('#esense-page-box').removeClass('is-mobile-menu');
			jQuery('#esense-mobile-menu').removeClass('is-mobile-menu');
