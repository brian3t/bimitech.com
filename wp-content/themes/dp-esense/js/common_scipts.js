...
//Vertical tabs
	...
	/* Lightbox */
	jQuery(document).ready(function() {
	jQuery('a[data-rel^="esense_lightbox"]').prettyPhoto({
		hook:'data-rel',
		deeplinking: true,
...
jQuery(window).load(function() {
	jQuery('#esense_status').fadeOut(); // will first fade out the loading animation
			jQuery('#esense_preloader').delay(350).fadeOut('slow'); // will fade out the white DIV that covers the website.
});
...
function shiftImages(){
	if(typeof $Esense_TABLET_WIDTH != 'undefined') {
        if (jQuery(window).width()< $Esense_TABLET_WIDTH) { jQuery(".shifted").removeClass("moved");
...
jQuery(document).ready(function() {	
	...
	jQuery(window).scroll(function() {
		if(typeof $Esense_STICKY_HEADER != 'undefined') {
		if ($Esense_STICKY_HEADER == 'Y') { 
		var switchvalue = jQuery('#esense-navigation-wrapper').height()+100;
		if(jQuery(this).scrollTop() >switchvalue && jQuery(window).width()> $Esense_TABLET_WIDTH ) {
		jQuery('#esense-navigation-wrapper').addClass('esense-sticky-navigation-wrapper');
		} else {
		jQuery('#esense-navigation-wrapper').removeClass('esense-sticky-navigation-wrapper');
		}
		}
		}
	});
	...
	// style area
	if(jQuery('#esense-style-area')){
		jQuery('#esense-style-area div').each(function(i){
	...
	if(jQuery('#esense-demo-area')){
		jQuery('#esense-demo-area div').each(function(i){
			jQuery(this).find('a').each(function(index) {
				jQuery(this).click(function(e){
	            	e.stopPropagation();
	            	e.preventDefault();
	...
	// font-size switcher
	if(jQuery('#esense-font-size') && jQuery('#esense-mainbody')) {
		var current_fs = 100;
		jQuery('#esense-mainbody').css('font-size', current_fs+"%");
		
		jQuery('#esense-increment').click(function(e){ 
			e.stopPropagation();
			e.preventDefault(); 
			
			if(current_fs < 150) { 
				jQuery('#esense-mainbody').animate({ 'font-size': (current_fs + 10) + "%"}, 200); 
				current_fs += 10; 
			} 
		});
		
		jQuery('#esense-reset').click(function(e){ 
			e.stopPropagation(); 
			e.preventDefault(); 
			
			jQuery('#esense-mainbody').animate({ 'font-size': "100%"}, 200); 
			current_fs = 100; 
		});
		
		jQuery('#esense-decrement').click(function(e){ 
			e.stopPropagation(); 
			e.preventDefault(); 
	...
	function changeStyle(style){
		var file = $Esense_TMPL_URL+'/css/'+style;
		jQuery('head').append('<link rel="stylesheet" href="'+file+'" type="text/css" />');
		jQuery.cookie($Esense_TMPL_NAME+'_style', style, { expires: 365, path: '/' });
	}
});
...
jQuery(document).ready(function(){
"use strict";
	jQuery('.esense-header-search').click(function () {
		jQuery('.esense-header-search-form').fadeIn(500);
	});
	jQuery('#cancel-search').click(function () {
jQuery('#esense-header-search-form').fadeOut(200);			
	});
});	
...
jQuery(window).load( function () {
	"use strict";
    jQuery(".esense-tipsy").tipsy({gravity: 'ne', fade: true, html: true, title: "data-tipcontent", opacity:1 });
	});
jQuery(window).load( function () {
	"use strict";
    jQuery(".esense-tipsy-t").tipsy({gravity: 's', fade: true, html: true, title: "data-tipcontent", opacity:1 });
    jQuery(".esense-tipsy-r").tipsy({gravity: 'w', fade: true, html: true, title: "data-tipcontent", opacity:1 });
	});
jQuery(window).load( function () {
	"use strict";
    jQuery(".esense-tipsy-l").tipsy({gravity: 'e', fade: true, html: true, title: "data-tipcontent", opacity:1 });
    jQuery(".esense-tipsy-b").tipsy({gravity: 'n', fade: true, html: true, title: "data-tipcontent", opacity:1 });
	});
jQuery(window).load( function () {
	"use strict";
    jQuery(".esense-tipsy1").tipsy({gravity: 'se', fade: true, html: true, title: "data-tipcontent", opacity:1 });
	});
	
jQuery(window).load( function () {
	"use strict";
    jQuery("#esense-social-icons.left a").tipsy({gravity: 'w', fade: true, html: true, title: "data-tipcontent", opacity:1 });
	});
jQuery(window).load( function () {
	"use strict";
    jQuery("#esense-social-icons.right a").tipsy({gravity: 'e', fade: true, html: true, title: "data-tipcontent", opacity:1 });
	});
...
jQuery(window).load(function() {
	...
	jQuery('.esense-wall ').isotope({
		itemSelector: '.item',
		layoutMode: 'masonry'
	});
	jQuery(window).resize(function(){ 
	 jQuery('.esense-wall ').isotope('layout');
 ...
 jQuery(document).ready(function() {	
		   ...
		   jQuery("#layout-style").change(function(e){
				if( jQuery(this).val() == 1){
					...
					bg= $Esense_TMPL_URL+'/images/patterns/noise_pattern_with_crosslines.png';
					jQuery("body").css("backgroundImage","url("+bg+")");
					jQuery(window).resize();
				}
			});
			//Background switcher
			jQuery('.esense-style-switcher-bg a').click(function() {
...
================================================== */
 jQuery(window).load(function() {
				jQuery("#esense-mobile-menu").mCustomScrollbar({
...
jQuery(document).ready(function() {
        ...
        jQuery('.esense-round-timer').easyPieChart;
		});
	jQuery(document).ready(function() {
...
================================================== */
	...
	jQuery(document).ready(function(){
		jQuery(".esense-header-search").removeAttr("href").click(function(){
...
jQuery(document).ready(function(){
	...
	jQuery('.esense-sidebar-button').click(function(e){
    e.preventDefault();
	jQuery('#esense-page-box').toggleClass('is-dynamic-sidebar');
	jQuery('#esense-dynamic-sidebar').toggleClass('is-dynamic-sidebar');
...
jQuery(document).ready(function(){
		...
		var width1 = (jQuery('.esense-page').outerWidth(true) - jQuery('.esense-page').outerWidth())/2;
...
jQuery(document).ready(function () {
if (!! jQuery('.esense_shopping_cart').length || !! jQuery('.esense-button-area').length )  {
...
jQuery(document).ready(function () {
	jQuery('.smooth-scroll, li.smooth-scroll .item-container a').click(function() {
				if (location.pathname.replace(/^\//,'') == this.pathname.replace(/^\//,'') && location.hostname == this.hostname) {
								...
								if (jQuery('#esense-navigation-wrapper').length) offset += jQuery('#esense-navigation-wrapper').height();
...
jQuery(document).ready(function($){
	var contentSections = $('.esense-anchor'),
		navigationItems = $('#dotnav-menu li a');
		dotnavContainer = $('.esense_dotnav_container');
...
jQuery( window ).scroll( function(){
 ...
 if ( $( '#dotnav-menu' ).length ) {
 				$add_offset = 0;
				if ( $( '.esense-sticky-navigation-wrapper' ).length ) $add_offset += 65;
...
/*  Aside menu JS */
	jQuery(document).ready(function() {
	jQuery('.esense-aside-menu-toggle').click(function(){
	jQuery('.esense-aside-navigation-wrapper').addClass('active');
	jQuery('.esense-aside-navigation-wrapper').animate({width: '260px'},500);
	jQuery(this).fadeOut();	
				});
	jQuery('.esense-aside-navigation-wrapper.slidingaside').mouseleave(function() {
			jQuery(this).removeClass('active');
				jQuery('.esense-aside-navigation-wrapper').delay(500).animate({width: '40px'},500);
					jQuery('.esense-aside-menu-toggle').delay(1000).fadeIn("slow");	
...
/* Overlay menu JS */
	jQuery(document).ready(function() {
	jQuery('.esense-overlay-menu-toggle').click(function(){
	jQuery('.esense-overlay-menu').toggleClass('open');
	});
	jQuery('.esense-overlay-menu-close').click(function(){
	jQuery('.esense-overlay-menu').toggleClass('open');
	});
	jQuery('.esense-overlay-menu li a').click(function(){
	jQuery('.esense-overlay-menu').toggleClass('open');
	});
	});
	
jQuery(document).ready(function(){
	var $elements = jQuery('.esense-overlay-menu li, .submenu');
jQuery('.esense-overlay-menu li.menu-item-has-children').hover(function() {
...
/*Flip boxes */
jQuery(document).ready(function(){
	jQuery('.esense-flipbox').each(function(){
...
/* Popup notications JS */
    jQuery(document).ready(function(){
    jQuery('.esense-popup-notification').each(function (index) {
...
jQuery(document).ready(function() {
	var mwidth = jQuery('#esense-page-box').width();
	jQuery('#esense-navigation-wrapper').css( "width", mwidth );
...
/* Sticky width menu adjust */
jQuery(document).ready(function() {
	var offset = (jQuery(window).width() - $Esense_TEMPLATE_WIDTH)/2;
	if (offset >= 0 ) 
...
function centerfooter(){
	if(typeof $Esense_SMALL_TABLET_WIDTH != 'undefined') {
        if (jQuery(window).width()<= $Esense_SMALL_TABLET_WIDTH) { 
jQuery('#esense-copyright-inner .social-bar').wrap('<div class="centered-block-outer"><div class="centered-block-middle"><div class="centered-block-inner"></div></div></div>');
				   //jQuery('.esense-copyrights').wrap('<div class="centered-block-outer"><div class="centered-block-middle"><div class="centered-block-inner"></div></div></div>');
				  }
	}
}
jQuery(document).ready(function() {
