...
class Esense_Custom_Menu {
	...
	function __construct() {
		...
		add_filter( 'wp_setup_nav_menu_item', array( $this, 'esense_add_custom_nav_fields' ) );

		// save menu custom fields
		add_action( 'wp_update_nav_menu_item', array( $this, 'esense_update_custom_nav_fields'), 10, 3 );
		
		// edit menu walker
		add_filter( 'wp_edit_nav_menu_walker', array( $this, 'esense_edit_walker'), 10, 2 );
	 ...
	 * @return      void
	*/
	function esense_add_custom_nav_fields( $menu_item ) {
	 ...
	 * @return      void
	*/
	function esense_update_custom_nav_fields( $menu_id, $menu_item_db_id, $args ) {
	 ...
	 * @return      void
	*/
	function esense_edit_walker($walker,$menu_id) {
	
	    return 'Esense_Walker_Nav_Menu_Edit';
	    
	}

}
// instantiate plugin's class
$GLOBALS['Esense_Custom_Menu'] = new Esense_Custom_Menu();
